...
from ..base import Kpt2dSviewRgbVidTopDownDataset, Kpt2dSviewRgbImgTopDownDataset
from ..top_down.topdown_coco_dataset import TopDownCocoDataset
...
@DATASETS.register_module(name='Custom_2D_Dataset')
# class Custom_2D_Dataset(Kpt2dSviewRgbVidTopDownDataset):
class Custom_2D_Dataset(Kpt2dSviewRgbVidTopDownDataset):
    ...
    def _get_db(self):
        ...
        if (not self.test_mode) or self.use_gt_bbox:
            ...
            print('use ground truth bbox')
            gt_db = self._load_coco_keypoint_annotations()
        else:
            # use bbox from detection
            print('use bbox from detection')
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        ann_ids = self.coco.getAnnIds(imgIds='{:06}'.format(img_id), iscrowd=False)
