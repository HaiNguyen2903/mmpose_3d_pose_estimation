...
@DATASETS.register_module(name='Custom3DPoseMPIFormatDataset')
class Custom3DPoseMPIFormatDataset(Kpt3dSviewKpt2dDataset):
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('configs/_base_/datasets/custom_3d_pose_mpi_format.py')
